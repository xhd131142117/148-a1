...
class Survey:
    ...
    def __len__(self) -> int:
        ...
        return len(list(self._questions.keys()))
    ...
    def __contains__(self, question: Question) -> bool:
        ...
        id as <question>.
        """
        return self._questions[question.id] in list(self._questions.values())
    ...
    def _get_criterion(self, question: Question) -> Criterion:
        ...
        """
        if question.id not in list(self._criteria.keys()):
    ...
    def _get_weight(self, question: Question) -> int:
        ...
        <question>.id occurs in this survey
        """
        if question.id not in list(self._weights.keys()):
